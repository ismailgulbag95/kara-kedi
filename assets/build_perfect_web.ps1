...
[System.IO.File]::WriteAllText("d:\benim antigravitiler\kara kedi\Kara_Kedi_Web_Surumu.html", $fullHtml, $utf8NoBom)
[System.IO.File]::WriteAllText("d:\benim antigravitiler\kara kedi\web\index.html", $fullHtml, $utf8NoBom)

Compress-Archive -Path 'd:\benim antigravitiler\kara kedi\web\*' -DestinationPath 'd:\benim antigravitiler\kara kedi\kara-kedi-web.zip' -Force
Write-Output "FIXED_PASSIVE_ITEMS_UNLIMITED_SLOTS_SUCCESS"
